...
const Navbar = () => {
   ...
   return (
    //{pathname ? opacity:0 : opacity:1}
       <header className="border-[#130611] border-solid border-2 flex flex-col justify-center bg-[#130611] z-[99999999] min-h-[7vh] py-2 lg:py-4 shadow-xl fixed w-full top-0">
